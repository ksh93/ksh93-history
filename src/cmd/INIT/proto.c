...
static const char id[] = "\n@(#)proto (AT&T Research) 2000-02-14\000\n";
...
#line 1 "../../lib/libast/include/hashkey.h"
...
#line 15 "../../lib/libast/port/astlicense.c"
...
astlicense __PARAM__((char* p, int size, char* file, char* options, int cc1, int cc2, int cc3), (p, size, file, options, cc1, cc2, cc3)) __OTORP__(char* p; int size; char* file; char* options; int cc1; int cc2; int cc3;){
	...
	if (notice.type != 1)
	{
		...
		if (notice.type == 5)
		{
			...
			comment( &notice, &buf, "If you have copied this software without agreeing",sizeof( "If you have copied this software without agreeing")-1, 0);
		...
		{
			comment( &notice, &buf, "This software was created by the",sizeof( "This software was created by the")-1, 0);
